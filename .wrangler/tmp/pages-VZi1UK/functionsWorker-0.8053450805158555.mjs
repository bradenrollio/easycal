...
// ../.wrangler/tmp/bundle-TmlYQ7/checked-fetch.js
...
async function createOrUpdateCalendar(payload, accessToken) {
  try {
    ...
    if (existingCalendar) {
      ...
      if (!response.ok) {
        const errorText = await response.text();
        console.error("Calendar creation failed:", response.status, errorText);
...
// ../.wrangler/tmp/pages-VZi1UK/functionsRoutes-0.7162382935109038.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-TmlYQ7/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-TmlYQ7/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8053450805158555.mjs.map
